                ...
                <ul class="nav navbar-nav navbar-right">  
                 <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo base_url('index.php/warden/logout') ;?>"><i class="fa fa-sign-out fa-fw"></i>Logout</a>  <!--to call logout func in student controller-->
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
        ...
        <div id="wrapper">
            <div id="sidebar-wrapper">
                ...
                <ul class="sidebar-nav" id="sidebar">     
                      <li id="" class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">See Requests<i class="fa fa-sign-out fa-fw sub_icon"></i></a>
                        <ul class="dropdown-menu">
                            <li>
                                <a id="leave_btn" href="<?php echo base_url('index.php/warden/see_requests') ;?>">For leave</a>
                            </li>
                            <li>
